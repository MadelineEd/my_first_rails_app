...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1554306584);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1554306824);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 0);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1554306704);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1554306555);
user_pref("browser.laterrun.bookkeeping.sessionCount", 1);
user_pref("browser.laterrun.enabled", true);
user_pref("browser.migration.version", 62);
user_pref("browser.newtabpage.activity-stream.impressionId", "{9cbce1c4-fce1-4a29-938d-8b124f5e39e1}");
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1554229800);
user_pref("browser.newtabpage.activity-stream.migrationRemainingDays", 3);
user_pref("browser.newtabpage.enhanced", true);
user_pref("browser.newtabpage.storageVersion", 1);
user_pref("browser.onboarding.notification.last-time-of-changing-tour-sec", 1554306561);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1554306588042");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1554308375042");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1554306572988");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1554310172988");
user_pref("browser.search.countryCode", "IN");
user_pref("browser.search.region", "IN");
user_pref("browser.slowStartup.averageTime", 11279);
...
user_pref("extensions.shield-recipe-client.user_id", "ea3fb6c8-d246-4926-b532-aa17aa91d0fe");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"abd9b46c-1cde-4b2f-8f6b-1168a40d99e1\"}");
user_pref("gecko.handlerService.migrated", true);
user_pref("media.gmp-gmpopenh264.abi", "x86_64-gcc3");
user_pref("media.gmp-gmpopenh264.lastUpdate", 1554306700);
user_pref("media.gmp-gmpopenh264.version", "1.7.1");
user_pref("media.gmp-manager.buildID", "20180406121424");
user_pref("media.gmp-manager.lastCheck", 1554306699);
...
user_pref("toolkit.startup.last_success", 1554306548);
user_pref("toolkit.telemetry.cachedClientID", "000e3f8c-0fce-4938-ac60-bf15b3e27457");
